...
import beans.fitday.databinding.ActivitysttMainBinding;

import java.util.ArrayList;
import java.util.Locale;

public class MainActivitystt extends AppCompatActivity implements View.OnClickListener{

    private final int REQ_CODE_SPEECH = 100;

    private ActivitysttMainBinding mainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainBinding = DataBindingUtil.setContentView(this, R.layout.activitystt_main);
