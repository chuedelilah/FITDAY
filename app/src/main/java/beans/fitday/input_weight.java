...
public class input_weight extends AppCompatActivity implements View.OnClickListener{
    Button back1;
    ...
    private input_weight.xServiceConnection mServiceConnection;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1  = (Button)findViewById(R.id.back1_Bn);
        back1.setOnClickListener(this);

        //按鈕事件
        button4 = (Button) findViewById(R.id.weight_Bn);
        button4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {

                // Check if BLE is supported on the device.
                if (!getPackageManager().hasSystemFeature(PackageManager.FEATURE_BLUETOOTH_LE)) {
                    Toast.makeText(input_weight.this, "BLE is not supported in this device!", Toast.LENGTH_SHORT).show();
                    //finish();
                }
                ...
                if (mBluetoothAdapter.isEnabled()) {
                    ...
                    editTextWeight = (EditText) findViewById(R.id.editText3);
                    scanLeDevice(true);
    ...
    public void onClick(View v) {
        if(v == back1)
        {
            ...
            intent.setClass(input_weight.this, home_weight.class);    //設定要置換的activity
            startActivity(intent);      //啟動設定的activity
            input_weight.this.finish();     //原本舊的activity結束
        }
    }
